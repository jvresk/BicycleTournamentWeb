...
if($s->dajKorisnika()["uloga"] <= 3){
    print_r($s->dajKorisnika()["uloga"]);
}
...
<head>
    ...
    <script src="./javascript/registrirani_prijava.js"></script>
...
<body >
    ...
    <nav>
        ...
        <li><a href="./index.php">Početna stranica</a></li>
            ...
            <?php if($s->ulogiran()) { ?>
            <li><a href="./registrirani_prijava.php?logout=1">Odjava</a></li>
            <?php } ?>
    ...
    <section id="registracija">
        ...
        <form novalidate name="reg" id="reg" method="post" action="./php/registrirani_prijava.php">
            <label>Ime: </label>
            <br>
            <input name="imeBiciklista" id="imeBiciklista" type="text" placeholder="Hrvoje" required="required" size="30" />
            <br>
            <label>Prezime: </label>
            <br>
            <input name="prezimeBiciklista" id="prezimeBiciklista" type="text" placeholder="Horvat" required="required" size="30" />
            <br>
            <label>Godina rođenja: </label>
            <br>
            <input name="godina_rod" id="godina_rod" type="number" placeholder="2000" required="required" value="2000" min="1900"
                max="2020" size="30"/>
            <br>
            <label>Kontakt: </label>
            <br>
            <input name="kontakt" id="kontakt" type="text" placeholder="0991231234" required="required" size="30" />
            <br>
            <br>

            <input name="submit" id="submit" type="submit" value="Pošalji prijavu" />
