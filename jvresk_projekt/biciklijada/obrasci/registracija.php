...
<head>
    ...
    <meta name="ključne riječi" content="novi, korisnik, registracija">
    ...
    <script defer type="text/javascript" src="../javascript/captcha.js"></script>
...
<body >
    ...
    <nav>
        ...
        <li><a href="../index.php">Početna stranica</a></li>
            ...
            <?php if($s->ulogiran()) { ?>
            <li><a href="./registracija.php?logout=1">Odjava</a></li>
            <?php } ?>
    ...
    <section id="registracija">
        <h2 class="tekst">Unesite podatke: </h2>
        <form novalidate name="reg" id="reg" method="post"
            action="../php/validacija_registracije.php">
            <label>Ime: </label>
            <br>
            <input name="imeKorisnika" id="imeKorisnika" type="text" placeholder="Hrvoje" required="required" size="30" />
            <br>
            <label>Prezime: </label>
            <br>
            <input name="prezime" id="prezime" type="text" placeholder="Horvat" required="required" size="30" />
            <br>
            <label>Korisničko ime: </label>
            <br>
            <input name="korisnicko_ime" id="korime" type="text" placeholder="hhorvat" required="required"
                maxlength="15" size="30" />
            <br>
            <label>Godina rođenja: </label>
            <br>
            <input name="godina_rod" type="number" placeholder="2000" required="required" value="2000" min="1900"
                max="2020" size="30"/>
            <br>
            <label>Email: </label>
            <br>
            <input name="email" id="email" type="email" placeholder="hhorvat@gmail.com" required="required" size="30" />
            <br>
            <label>Lozinka: </label>
            <br>
            <input name="lozinka" id="lozinka" type="password" placeholder="********" required="required" size="30" />
            <br>
            <label>Unesite ponovno lozinku: </label>
            <br>

            <input name="potvrda" id="potvrda" type="password" placeholder="********" required="required" size="30" />
            <br>

            
            <label>Unesite znakove sa slike:</label> <br>
            <div id="canvas">
                <canvas id="textCanvas" height=50 width=300></canvas>
                <input id=captcha type="text" size="30"/>
            </div>
    ...
    <footer>
        <div class="footer">
            ...
            <map name="val2">
                <area
                    href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fbarka.foi.hr%2FWebDiP%2F2019%2Fzadaca_04%2Fjvresk%2Fobrasci%2Fregistracija.html"
