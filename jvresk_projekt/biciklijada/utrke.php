...
<head>
    ...
    <meta name="ključne riječi" content="utrke, korisnik, prijava">
    ...
    <script src="javascript/popis_utrka.js"></script>
    <script src="javascript/pretrazi.js"></script>
...
<body>
    ...
    <nav>
        ...
        <li><a href="./index.php">Početna stranica</a></li>
            ...
            <?php if($s->ulogiran()) { ?>
            <li><a href="./utrke.php?logout=1">Odjava</a></li>
            <?php } ?>
    ...
    <input type="text" id="unos" onkeyup="PretraziDatum()" placeholder="Pretraži po datumu...">
    
        <table border="1">
            <caption >Utrke: </caption><br>
