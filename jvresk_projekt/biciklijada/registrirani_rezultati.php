...
<head>
    ...
    <script src="javascript/registrirani_rezultati.js"></script>
    <script src="javascript/registrirani_odustani.js"></script>
...
<body>
    ...
    <li><a href="./index.php">Početna stranica</a></li>
            ...
            <?php if($s->ulogiran()) { ?>
            <li><a href="./registrirani_rezultati.php?logout=1">Odjava</a></li>
            <?php } ?>
    ...
    <form novalidate name="slika" id="slika" method="POST" >
            <fieldset>
                <label>Spremi sliku: </label><br><br>
                <label>ID utrke: </label>
                <input type="text" id="id_utrke" name="id_utrke" /> <br><br>
                <label>Poveznica na sliku: </label>
                <input type="url" id="adresa" name="upute" /> <br><br>
                <label for="suglasnost">Suglasnost: </label>
                <select id="suglasnost">
                    <option value="1"> Suglasan </option>
                    <option value="0"> Nisam suglasan </option>
                </select>
                <br><br>
            ...
            <fieldset>
            <label>ID utrke: </label>
                <input type="text" id="id_utrke2" name="id_utrke" /> <br><br>
                <label>Razlog odustajanja: </label>
                <input type="text" id="razlog" name="razlog" /> <br><br>
                <label > Odustani od utrke </label>
                <input type="submit" id="odustani" name="odustani" value="odustani">
            </fieldset>
